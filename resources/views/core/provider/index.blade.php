...
@section('content')
            ...
            <div class="dt-login__bg-section">
                ...
                <div class="dt-login__logo">
                    <a class="dt-brand__logo-link" href="#">
                        <img class="dt-brand__logo-img" src="{{ url('/') }}/drift/assets/images/logo-white.jpeg" alt="Drift">
                    </a>
                </div>
                <!-- /brand logo -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="ajax-post" id="providerRegistration" method="post" action="{{ url('register') }}">
    ...
    <script>
        $('.ajax-post').submit(function (event) {
            ...
            console.log('i am hre and url is '+url);
