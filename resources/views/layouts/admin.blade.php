...
{{--                                            </a>--}}
                        ...
                        <ul class="dt-nav">
                            <li class="dt-nav__item dropdown">
                                ...
                                @if(auth()->user()->role == 'provider')
                                    <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img class="dt-avatar size-30" src="{{ url('frontend/assets/user.png') }}" alt="Provider Avatar">
                                ...
                                <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="dt-avatar size-30" src="{{ url('frontend/assets/user.png') }}" alt="Domnic Harris">
                                    <span class="dt-avatar-info d-none d-sm-block">
                                <span class="dt-avatar-name">{{ auth()->user()->name }}</span>
                                </span>
                                </a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="text-success text-center" id="verificationModalLabel"> <h4>Phone Verification</h4></h5>
